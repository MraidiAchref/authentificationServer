...
const { errorWrapper } = require('./errorHandler');
...
exports.generateRefreshToken = (user) => jwt.sign(user, process.env.ACCESS_TOKEN_SECRET_REFRESH, { expiresIn: process.env.REFRESH_TOKEN_DURATION });
